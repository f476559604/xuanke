...
function sGetSelect() {
    var vName = document.getElementById("txtSBJ8").value;
    if (vName != "") {
        var v = document.getElementById("selProvince");
        for (var i = 0; i < v.options.length; i++) {
            if (v.options[i].value == vName) {
                v.options[i].selected = true;
                break;
            }
        }
        getCity(vName);
        vName = document.getElementById("txtSBJ9").value;
        v = document.getElementById("selCity");
        for (var i = 0; i < v.options.length; i++) {
            if (v.options[i].value == vName) {
                v.options[i].selected = true;
                break;
