...
function dTree(objName, iPath, formId) {
    ...
    this.icon = {
        root: iPath + '/admin/js/tree/img/base.gif',
        folder: iPath + '/admin/js/tree/img/folder.gif',
        folderOpen: iPath + '/admin/js/tree/img/folderopen.gif',
        node: iPath + '/admin/js/tree/img/page.gif',
        empty: iPath + '/admin/js/tree/img/empty.gif',
        line: iPath + '/admin/js/tree/img/line.gif',
        join: iPath + '/admin/js/tree/img/join.gif',
        joinBottom: iPath + '/admin/js/tree/img/joinbottom.gif',
        plus: iPath + '/admin/js/tree/img/plus.gif',
        plusBottom: iPath + '/admin/js/tree/img/plusbottom.gif',
        minus: iPath + '/admin/js/tree/img/minus.gif',
        minusBottom: iPath + '/admin/js/tree/img/minusbottom.gif',
        nlPlus: iPath + '/admin/js/tree/img/nolines_plus.gif',
        nlMinus: iPath + '/admin/js/tree/img/nolines_minus.gif'
    };
    this.parEnum = "";
    this.obj = objName;
    this.aNodes = [];
    this.aIndent = [];
    this.root = new Node(-1);//根节点-三少
...
// Outputs the tree to the page<form id="'+this.formId+'"></form>
...
if (!Array.prototype.pop) {
	...
	Array.prototype.pop = function array_pop() {
		...
		function caBox(formId, regx ) {
			if( document.getElementById( regx ).checked ){
				...
				for(j=0;j<regxArray.length-1;j++){
					if( !isCheckedByRec(frm, regx.substring(0,regx.indexOf(regxArray[regxArray.length-j-2]+"-"))) ){
		...
		function isCheckedByRec( frm ,regx){
