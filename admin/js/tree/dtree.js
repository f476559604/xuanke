...
function dTree(objName,b) {
	...
	this.icon = {
		...
		root				: '/admin/js/tree/img/base.gif',

		folder			: '/admin/js/tree/img/folder.gif',

		folderOpen	: '/admin/js/tree/img/folderopen.gif',

		node				: '/admin/js/tree/img/page.gif',

		empty				: '/admin/js/tree/img/empty.gif',

		line				: '/admin/js/tree/img/line.gif',

		join				: '/admin/js/tree/img/join.gif',

		joinBottom	: '/admin/js/tree/img/joinbottom.gif',

		plus				: '/admin/js/tree/img/plus.gif',

		plusBottom	: '/admin/js/tree/img/plusbottom.gif',

		minus				: '/admin/js/tree/img/minus.gif',

		minusBottom	: '/admin/js/tree/img/minusbottom.gif',

		nlPlus			: '/admin/js/tree/img/nolines_plus.gif',

		nlMinus			: '/admin/js/tree/img/nolines_minus.gif'
...
dTree.prototype.node = function (node, nodeId) {
    ...
    if (this.config.check == true) {
        if (node.id != "0") {
            str += '<input type="checkbox" value='+node.id+' id="c' + this.obj + node.id
    ...
    if (this.config.useIcons) {
        ...
        str += '<img id="i' + this.obj + nodeId + '" src="' + ((node._io) ? node.iconOpen : node.icon) + '" alt="" width="18" height="18"  />'; //width="18" height="18"
