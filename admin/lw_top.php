...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="64"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="227" height="64" background="style/green/images/main_06.gif" nowrap="nowrap" valign="middle" align="right" ></td>
                  ...
                  <td width="75" height="26" style="cursor: hand" onmouseover="this.style.backgroundImage='url(style/green/images/main_18.gif)';this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#adb9c2'; "
                                                          ...
                                                          <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div align="center">
                                                                                <span class="SkyTopFont2"><a href="lw_index.php" target="main" class="v1">系统首页</a></span></div>
                                                                      </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                      ...
                                                      echo('<td width="75" style="cursor: hand" onmouseover="this.style.backgroundImage=\'url(style/green/images/main_18.gif)\';this.style.borderStyle=\'solid\';this.style.borderWidth=\'1\';borderColor=\'#adb9c2\'; "
                                                                onmouseout="this.style.backgroundImage=\'url()\';this.style.borderStyle=\'none\'">
                                                          <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <div align="center">
                                                                                <span class="SkyTopFont2"><a href="lw_info.php" target="main" class="v1">系统说明</a></span></div>
                                                                      </td>
                                                                    </tr>
                                                                </table>
                                                            </td>');
                                                      ...
                                                      <td width="75" style="cursor: hand" onmouseover="this.style.backgroundImage='url(style/green/images/main_18.gif)';this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#adb9c2'; "
                                                                ...
                                                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div align="center">
                                                                                <span class="SkyTopFont2"><a href="lw_help.php" target="main" class="v1">软件帮助</a></span></div>
                                                                      </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                   <td width="75" style="cursor: hand" onmouseover="this.style.backgroundImage='url(../style/green/images/main_18.gif)';this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#adb9c2'; "
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div align="center">
                                                                                <span class="SkyTopFont2"><a href="other_user/pass_change.php" target="frameright" class="v1">更改密码</a></span></div>
                                                                      </td>
                                                                    </tr>
                                                                </table>
                                                            </td>    
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div align="center">
                                                                                <span class="SkyTopFont2"><a href="lw_exit.php" target="main" class="v1">退出系统</a></span></div>
                                                                      </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
