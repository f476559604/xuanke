...
function stu_sco_list($aid=0){
    ...
    $head_html.='<tr class="SkyTDTopLine" align="center"><th scope="col">序号</th><th scope="col">课程名称</th><th scope="col">学分</th><th scope="col">平时成绩及表现</th><th scope="col">期中成绩</th><th scope="col">期末成绩</th><th scope="col">总成绩</th><th scope="col">1-9周考勤</th><th scope="col">10-18周考勤</th><th scope="col">本学期考勤</th><th scope="col">学期</th><th scope="col">编辑</th></tr>';
    $body_html='';
    //echo "ssdd";
