...
if($new_id!=''&&$new_name!=''){
    //echo 'sdf';
    $sql="update obj_list set obj_name='".$new_name."' where obj_id='".$new_id."'";
    //echo $sql;
...
<form action="" method="post">
                <div class="divInfoContext">
                    ...
                    <?php
                    $sql="select obj_id,obj_name from obj_list where obj_id='".$obj_id."'";
                    //echo $sql;
                    $query=mysql_query($sql);
                    ...
                    $html.='<td><input name="new_id" readonly type="text" value="'.$re['obj_id'].'"/></td><td><input name="new_name" type="text" value="'.$re['obj_name'].'"/></td>';    
                    $html.='</tr></table>';
                    echo($html);
                    ?>
