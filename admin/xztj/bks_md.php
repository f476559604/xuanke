...
<body>
            ...
            <div class="divInfoContext">
                <div style="text-align: center;">本科生名单</div>
                <table width="100%" border="1" cellpadding="0" cellspacing="0" class="SkyTableLine">
                    ...
                    <?php
                    $sql="select stu_clas,stu_id,user_name,entrydate,gradate,stu_sex,nature,stu_nation from user_stu where nature like '%本科%' and stu_clas<='1010902' order by stu_clas asc";
                    ...
                    while($re=mysql_fetch_assoc($query)){
                        //if($re[0]!=''){
                            ...
                            $html.='<td class="SkyTDInfo">'.$re['user_name'].'</td>'.'<td class="SkyTDInfo">'.$re['entrydate'].'</td>';
                            $html.='<td class="SkyTDInfo">'.$re['gradate'].'</td>'.'<td class="SkyTDInfo">'.$re['stu_sex'].'</td>';
