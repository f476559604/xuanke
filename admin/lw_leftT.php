...
<?php
    ...
    $sql="select ID,parentID,mName,mUrl,mToolTip,mTarget,mIopen,mIclose from `lwmenu` where isDel='N' and (mExpand='T' or mExpand='B') order by showID asc";
    $query=mysql_query($sql);
    while($res=mysql_fetch_row($query)){
        echo("d.add('$res[0]','$res[1]','$res[2]','$res[3]','$res[4]','$res[5]','$res[6]','$res[7]');");
    }
	sco_cla_list($_SESSION['term_now'],$_SESSION['user_id'],65,'sco_dis');
    sco_cla_list($_SESSION['term_now'],$_SESSION['user_id'],66,'sco_edit');
