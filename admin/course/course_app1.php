...
echo '</select> <a href="#" id="del_sch1" onclick="del_sch(this)" style="display:none;"> 删除这个院系</a> <a href="#" id="add_sch1" onclick="add_sch(this)"> 添加院系</a> ';
?>  
                                    </td>
                                    <td width="100">
                                ...
                                <tr class="MeNewTDLine" id="s11">
                                    ...
                                    <a href="#" id="del_11" onclick="del_major(this)" style="display:none;"> 删除这个专业</a><a href="#" id="add_maj11" onclick="add_maj(this)"> 添加专业</a>
...
<form id="Form1" >
                ...
                <div class="divSave">
                    <input type="button" id="btnSubmit" value="保存" class="SkyButtonFocus" onclick="data_handle()" />
