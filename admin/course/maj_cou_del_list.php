<?php
    ...
    function maj_cou_del($table_name){
            ...
            if($_SESSION['choose_allow']==2){
                ...
                $table_head.='</tr>';
                //echo $cou_sql;
                $cou_sql='cou_id,cou_name,cou_code,cou_type,cou_volume,cou_selected,cou_credit,cou_time_detail,teach_teacher,cou_week_to,cou_classroom,cou_nums,cou_weekcycle';
                echo($table_head);
                
                global $num;
                
                $cou_chose="select cou_all from maj_course where class_id='".$num."' and cou_term='".$_SESSION['term_now']."'";
                ...
                for($i=0;$i<count($cou_chose);$i++){
                   if($cou_chose[$i]!=NULL){
                        ...
                        if($cou_query!=''){    
                            ...
                            foreach($cou_query as $key=>$value){
