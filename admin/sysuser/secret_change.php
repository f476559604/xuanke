...
<form id="Form1" method="post" action="secret_change_ok.php">    
            <div class="divInfo">
                ...
                <div class="divInfoContext">
                    ...
                    <table class="Ntable" cellspacing="1" cellpadding="0" align="Center" border="0" id="gvInfo" style="border-style:None;width:100%;">
                        ...
                        <tr class="SkyTDTopLine" align="center"><th scope="col">编号</th><th scope="col">姓名</th><th scope="col">原来密码</th><th scope="col">现在密码</th></tr>
                        <tr class="SkyTDLine" align="center">
                        <?php
                        $html='<td>'.$id.'</td><td>'.$name.'</td><td><input name="old1" value="" type="password"/></td><td><input name="new1" value="" type="password"/></td>';
                        echo $html;
                        ?>
