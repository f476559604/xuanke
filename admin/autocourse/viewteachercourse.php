                ...
                <div class="divInfo">
                    <div class="divInfoblack">
                        <div class="divInfoTopList">
                            <div class="listLeft">
                                <div class="navtitle">
                                    <?php if($name1){echo($name1);}else{echo('老师课表');}?></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="divInfo">
                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tablist" id="mainlist">
                        <tr class="tablisttr">
                            ...
                            <td width="100" class="tablisttitle">
                                <a href="../toexcel/tea_xls.php?name=<?php echo($name1);?>&teaid=<?php echo($id);?>&nterm=<?php echo($_SESSION['term_now']);?>">导出教室课表</a>
                            </td>
                        ...
                        <tr class="tablisttr">
                            <td colspan="4">
                                <div style="width: 100%;">
                                 <?php
                                 include "tea_cou_tab.php";
                                 tea_cou_tab('tea_course');
                                 ?>   
                                </div>
                            </td>
                        </tr>
