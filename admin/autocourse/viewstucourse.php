...
<body>
    ...
    <div id="UpdateProgress1" style="display:none;">
            ...
            <div id="divLoading">
                <img src="../style/default/images/loading.gif" />
            </div>
                ...
                <div class="divInfo">
                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tablist" id="mainlist">
                        <tr class="tablisttr">
                            ...
                            <td class="tabmanagertr" align="left" style="width:40%">
                                <!--<p id="searchSubmit">
                                <input type="submit" name="btnSearch" value="导出数据" id="btnSearch" class="SkyButtonFocus" style="width:78px;" />
                                </p>-->
                            </td>
                        </tr>
                        <tr class="tablisttr">
                            <td colspan="4">
                                <div style="width: 100%;">
                                 <?php
                                 include "stu_cou_tab.php";
                                 stu_cou_tab('stu_course');
                                 ?>   
                                </div>
                            </td>
                        </tr>
