...
$num=$_GET['iidd2'];
//$num='201392503039';
$sql="select stu_gra,user_name,stu_sex from user_stu where stu_id='$num'";
...
$worksheet->write(2, 8, "", $format_border_b);
...
$worksheet->write(3, 5, '', $format_border);
...
$worksheet->write(3, 11, "考试时间", $format_border);
    ...
    if($jj%2==0){
        ...
        while($re=mysql_fetch_assoc($query)){
            if($ii==0){
                ...
                $worksheet->write($hh, 11, '', $format_border_o_r);
                $ii=1;
                $hh++;
            }
...
for($mm=4;$mm<$kk;$mm++){
    ...
    $worksheet->mergeCells($mm,4,$mm,5);
